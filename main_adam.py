...
def initialize_model_and_optimizer(device):
    ...
    # Change from SGD to Adam optimizer
...
def plot_loss(train_loss, valid_loss, output_dir,epoch):
    ...
    figure_1.savefig(f"{output_dir}/train_loss_epoch_{epoch + 1}.png")
    figure_2.savefig(f"{output_dir}/valid_loss_epoch_{epoch + 1}.png")
...
def main():
    ...
    for epoch in range(start_epoch, config.num_epochs):
        ...
        plot_loss(loss_dict['train_loss'], loss_dict['valid_loss'], output_dir,epoch)
